...
export async function POST(req: Request) {
    ...
    try {
        ...
        const { firstName, lastName, phone, email, date, time } = body;
        ...
        if (contactId) {
            const taskmessage: string = "Schedule appointment at " +date +", time: " +time;
          ...
          `https://api.hubapi.com/crm/v3/objects/tasks`,
          {
            ...
            body: JSON.stringify({
              properties: {
                ...
                hs_task_subject: 'Schedule appointment',
