...
export async function generateMetadata({ params }: { params: Promise<SectionProps> }) {
...
export default async function Contact({ params }: { params: Promise<SectionProps> }) {
  ...
  if (!page) {
    return <div className="text-center py-20">Contact page not found!</div>;
  }

  console.log("contact page lang", lang);
