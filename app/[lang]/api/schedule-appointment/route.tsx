...
export async function POST(req: Request) {
    ...
    try {
        ...
        const { firstName, lastName, phone, email, subject, message, date, time, lang } = body;
            ...
            'https://api.hubapi.com/crm/v3/objects/contacts',
            {
                ...
                body: JSON.stringify({
                    properties: {
                        ...
                        form_source: "website_schedulecall_form",
                    },
                }),
            }
            );
        ...
        if (contactId) {
            const taskmessage: string = "Schedule appointment at " +date +", time: " +time +" use case: " +subject +" message: " +message;
          ...
          `https://api.hubapi.com/crm/v3/objects/tasks`,
          {
            ...
            body: JSON.stringify({
              properties: {
                ...
                hs_task_body: taskmessage,
                hs_task_subject: 'Schedule call',
